...
![Version](https://img.shields.io/badge/latest-v0.0.22-blue)
...
curl \
  ...
  --create-dirs \
  -o data/imported/clocktower.json \
  https://raw.githubusercontent.com/chizmw/json-on-the-clocktower/v0.0.22/data/generated/roles-combined.json
```
